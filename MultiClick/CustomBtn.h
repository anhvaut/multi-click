...
public:
    ...
    enum	{	ST_ALIGN_HORIZ	= 0,			// Icon/bitmap be^n  left, text be^n  right
				ST_ALIGN_VERT,					// Icon/bitmap be^n  top, text be^n  bottom
				ST_ALIGN_HORIZ_RIGHT,			// Icon/bitmap be^n  right, text be^n  left
				ST_ALIGN_OVERLAP				// Icon/bitmap cu`ng be^n  text
			};

	enum	{	BTNST_COLOR_BK_IN	= 0,		// Background color khi chuo^.t tre^n nu't
				BTNST_COLOR_FG_IN,				// Text color khi chuo^.t tre^n nu't
				BTNST_COLOR_BK_OUT,				// Background color khi chuo^.t ngoa`i  nu't
				BTNST_COLOR_FG_OUT,				// Text color when khi chuo^.t ngoa`i nu't
				BTNST_COLOR_BK_FOCUS,			// Background color khi button nha^.n focus
				BTNST_COLOR_FG_FOCUS,			// Text color khi button nha^.n focus
