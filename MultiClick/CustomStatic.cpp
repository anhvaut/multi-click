...
void CustomStatic::FreeResources(BOOL bCheckForNULL)
{
	if (bCheckForNULL)
	{
...
HBRUSH CustomStatic::CtlColor(CDC* pDC, UINT nCtlColor) 
{
	return (HBRUSH)::GetStockObject(NULL_BRUSH); 
} // End of CtlColor

void CustomStatic::OnLButtonUp(UINT nFlags, CPoint point) 
{
...
void CustomStatic::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
...
void CustomStatic::DrawItem(CDC* pDC)
{
	CString sText;
	CRect rCtrl;
...
void CustomStatic::DrawTheIcon(CDC* pDC, CRect* rpCtrl, BOOL bText)
{
	int		nX = 0, nY = 0;
	CRect	rIcon;
...
void CustomStatic::DrawTheText(CDC* pDC, CRect* rpCtrl, CString& sText, DWORD dwStyle, DWORD dwExStyle)
{
	CRect	rText;
	int		nX = 0, nY = 0;
...
//
void CustomStatic::SetTextColor(COLORREF crTextColor, BOOL bRepaint)
{
...
//				If TRUE the control will be repainted.
//
void CustomStatic::SetBkColor(COLORREF crBkColor, BOOL bRepaint)
{
...
//				If TRUE the control will be repainted.
//
void CustomStatic::SetColors(COLORREF crTextColor, COLORREF crBkColor, BOOL bRepaint)
{
...
//
DWORD CustomStatic::SetIcon(int nIcon, BOOL bRepaint, HINSTANCE hInstance)
{
...
//			Failed loading the specified resource.
//
DWORD CustomStatic::SetIcon(HICON hIcon, BOOL bRepaint)
{
	BOOL		bRetValue;
	ICONINFO	ii;
...
// Return value:	none
//
void CustomStatic::SetBold(BOOL bBold, BOOL bRepaint)
{
	LOGFONT logfont;
	CFont*	pFont = NULL;
...
void CustomStatic::ActivateTooltip(BOOL bActivate)
{
...
void CustomStatic::SetTooltipText(LPCTSTR lpszText, BOOL bActivate)
{
...
void CustomStatic::SetTooltipText(int nId, BOOL bActivate)
{
	CString sText;
...
BOOL CustomStatic::PreTranslateMessage(MSG* pMsg) 
{
	InitToolTip();
...
//			Invalid click type.
//
DWORD CustomStatic::SetMessageClick(BYTE byClickType, HWND hWnd, UINT nMsg)
{
...
void CustomStatic::PaintBk(CDC* pDC)
{
...
DWORD CustomStatic::SetBk(CDC* pDC)
{
...
DWORD CustomStatic::DrawTransparent(BOOL bRepaint)
{
...
DWORD CustomStatic::OnDrawBackground(CDC* pDC, LPCRECT pRect)
{
