...
void CWebBrowser2::Write(){
			m_pHtmlDoc=NULL;
		IDispatch* m_pDispatch = CWebBrowser2::GetDocument();
		...
		if(m_pDispatch)
		{
			...
			variant->vt      = VT_BSTR;
			variant->bstrVal = CString(m_String).AllocSysString();
			
			SafeArrayUnaccessData(safe_array);
			
		//	m_pHtmlDoc->write(safe_array);
			m_pHtmlDoc->Release();
